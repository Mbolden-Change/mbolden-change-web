...
export const tabType = defineType({
    ...
    fields: [
        ...
        title: 'Tab Content',
        type: 'array',
        description: 'Rich text for the tab. You can also insert a Text & Media or Leadership block anywhere in the flow.',
        of: [{ type: 'block'}, { type: 'textMedia'}, { type: 'leadership'}],
