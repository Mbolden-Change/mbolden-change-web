const  data = {
    ...
    {question: "WHAT COUNTS AS INCOME FROM WORK OR EARNED INCOME?  ", 
        ...
        {question: "I DON’T HAVE A SOCIAL SECURITY NUMBER (SSN). CAN I STILL GET MONEY BACK?", 
        answer: "You cannot claim federal tax credits without a Social Security number valid for work You may be able to claim California tax credits (CalEITC and Young Child Tax Credit) if you have a valid ITIN.  "},
        {question: "I DIDN’T OWE ANY TAXES THIS YEAR. IS IT STILL WORTH FILING?  ", 
        answer: "Yes. Some tax credits can put money back in your pocket, even if you owe $0 in taxes. You  must file a tax return to receive this money."},
